...
public class MumlaActivity extends AppCompatActivity implements ListView.OnItemClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Falconclaw: request Nearby devices permission so the service can read the
        // BLU-PTT button over BLE (Android 12+).
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S &&
                ContextCompat.checkSelfPermission(this, Manifest.permission.BLUETOOTH_CONNECT)
                        != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this,
                    new String[]{Manifest.permission.BLUETOOTH_CONNECT}, PERMISSIONS_REQUEST_BLUETOOTH);
        }
